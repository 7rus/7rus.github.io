                                            ...
                                            if (O.currentValue = T, "tween" === M) m = T;
                                                ...
                                                if (y.Hooks.registered[M]) {
                                                    var I = y.Hooks.getRoot(M),
                                                        A = a(C).rootPropertyValueCache[I];
                                                    A && (O.rootPropertyValue = A)
                                                }
                                                var $ = y.setPropertyValue(C, M, O.currentValue + (0 === parseFloat(T) ? "" : O.unitType), O.rootPropertyValue, O.scrollData);
                                                y.Hooks.registered[M] && (a(C).rootPropertyValueCache[I] = y.Normalizations.registered[I] ? y.Normalizations.registered[I]("extract", null, $[1]) : $[1]), "transform" === $[0] && (S = !0)
                                            }
                                        }
                        ...
                        function t(t) {
                            ...
                            function m() {
                                ...
                                if (o && n) l.emToPx = L.lastEmToPx, l.percentToPxWidth = L.lastPercentToPxWidth, l.percentToPxHeight = L.lastPercentToPxHeight;
                                    ...
                                    }), g.CSS.setPropertyValue(c, "paddingLeft", s + "em"), l.percentToPxWidth = L.lastPercentToPxWidth = (parseFloat(y.getPropertyValue(c, "width", null, !0)) || 1) / s, l.percentToPxHeight = L.lastPercentToPxHeight = (parseFloat(y.getPropertyValue(c, "height", null, !0)) || 1) / s, l.emToPx = L.lastEmToPx = (parseFloat(y.getPropertyValue(c, "paddingLeft")) || 1) / s, t.myParent.removeChild(c)
                                }
                            ...
                            if ("scroll" === T) {
                                ...
                                var I = u.extend(!0, {}, a(r).tweensContainer);
                                for (var A in I)
                                    if ("element" !== A) {
                                        var $ = I[A].startValue;
                                        I[A].startValue = I[A].currentValue = I[A].endValue, I[A].endValue = $, p.isEmptyObject(w) || (I[A].easing = c.easing), g.debug && console.log("reverse tweensContainer (" + A + "): " + JSON.stringify(I[A]), r)
                                    }
                                d = I
                            } else if ("start" === T) {
                                for (var D in a(r).tweensContainer && !0 === a(r).isAnimating && (I = a(r).tweensContainer), u.each(b, function(t, e) {
                                    ...
                                    var z = y.Hooks.getRoot(D),
                                        N = !1;
                                    if (a(r).isSVG || "tween" === z || !1 !== y.Names.prefixCheck(z)[1] || y.Normalizations.registered[z] !== n) {
                                        (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(D) && !V && 0 !== R && (V = 0), c._cacheValues && I && I[D] ? (V === n && (V = I[D].endValue + I[D].unitType), N = a(r).rootPropertyValueCache[z]) : y.Hooks.registered[D] ? V === n ? (N = y.getPropertyValue(r, z), V = y.getPropertyValue(r, D, N)) : N = y.Hooks.templates[z][1] : V === n && (V = y.getPropertyValue(r, D));
                                        var B, H, j, Y = !1;
                                        if (V = (B = f(D, V))[0], j = B[1], R = (B = f(D, R))[0].replace(/^([+-\/*])=/, function(t, e) {
                                                return Y = e, ""
                                            }), H = B[1], V = parseFloat(V) || 0, R = parseFloat(R) || 0, "%" === H && (/^(fontSize|lineHeight)$/.test(D) ? (R /= 100, H = "em") : /^scale/.test(D) ? (R /= 100, H = "") : /(Red|Green|Blue)$/i.test(D) && (R = R / 100 * 255, H = "")), /[\/*]/.test(Y)) H = j;
                                        else if (j !== H && 0 !== V)
                                            if (0 === R) H = j;
                                            else {
                                                o = o || m();
                                    ...
                                    } else g.debug && console.log("Skipping [" + z + "] due to a lack of browser support.")
                                }
                                d.element = r
                            }
                            d.element && (y.Values.addClass(r, "velocity-animating"), E.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, S === C - 1 ? (g.State.calls.push([E, v, c, null, O.resolver]), !1 === g.State.isTicking && (g.State.isTicking = !0, l())) : S++)
                        }
                        var o, r = this,
                                ...
                                if (!u.isPlainObject(b) || p.isEmptyObject(b)) {
                                    if (p.isString(b) && g.Redirects[b]) {
                                        ...
                                        return !0 === D.backwards && (v = u.extend(!0, [], v).reverse()), u.each(v, function(t, e) {
                                            parseFloat(D.stagger) ? D.delay = I + parseFloat(D.stagger) * t : p.isFunction(D.stagger) && (D.delay = I + D.stagger.call(e, t, C)), D.drag && (D.duration = parseFloat(P) || (/^(callout|transition)/.test(b) ? 1e3 : m), D.duration = Math.max(D.duration * (D.backwards ? 1 - t / C : (t + 1) / C), .75 * D.duration, 200)), g.Redirects[b].call(e, e, D || {}, t, C, v, O.promise ? O : n)
                                        }), t()
                                    }
                                    var A = "Velocity: First argument (" + b + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                    return O.promise ? O.rejecter(new Error(A)) : console.log(A), t()
                                }
                                T = "start"
                        }
                        var $, D, L = {
                ...
                e.exports = {
                    ...
                    update: function(t, e, i) {
                        if (t) {
                            ...
                            }), P = l, I = c, A = u, $ = d, n.each(h, function(t) {
                                P += t.width
                            }), n.each(p, function(t) {
                                I += t.width
                            }), n.each(f, function(t) {
                            ...
                            P += D, I += Math.max(T - I, 0);
                            var L = Math.max(O - A, 0);
                            A += L, $ += Math.max(_ - $, 0);
                            var E = i - A - $,
                                F = e - P - I;
                            F === k && E === C || (n.each(h, function(t) {
                                t.height = E
                            }), n.each(p, function(t) {
                                t.height = E
                            }), n.each(f, function(t) {
                            ...
                            var R = l + D,
                                W = u + L;
                            n.each(h.concat(f), z), R += k, W += C, n.each(p, z), n.each(m, z), t.chartArea = {
                                left: P,
                                top: A,
                                right: P + k,
                                bottom: A + C
                        ...
                        function z(t) {
                            t.isHorizontal() ? (t.left = t.fullWidth ? l : P, t.right = t.fullWidth ? e - c : P + k, t.top = W, t.bottom = W + t.height, W = t.bottom) : (t.left = R, t.right = R + t.width, t.top = A, t.bottom = A + C, R = t.right)
                        }
                    }
                }
            }, {
                    ...
                    draw: function(t) {
                        ...
                        if (i.display) {
                            var o = e.ctx,
                                ...
                                I = "bottom" === i.position ? e.top + O : e.bottom - w - O,
                                A = "bottom" === i.position ? e.top + O + w : e.bottom + O;
                            if (a.each(v, function(n, o) {
                                    if (!a.isNullOrUndef(n.label)) {
                                        var c, u, d, p, g, b, y, x, k, C, S, $, D, L, E = n.label;
                                        ...
                                        if (m) {
                                            ...
                                            var z = l(e, o, h.offsetGridLines && v.length > 1);
                                            z < e.left && (u = "rgba(0,0,0,0)"), z += a.aliasPixel(c), D = e.getPixelForTick(o) + s.labelOffset, g = y = k = S = z, b = I, x = A, C = t.top, $ = t.bottom + O
                                        } else {
                                            var N, B = "left" === i.position;
                                            s.mirror ? (F = B ? "left" : "right", N = W) : (F = B ? "right" : "left", N = w + W), D = B ? e.right - N : e.left + N;
                                            var H = l(e, o, h.offsetGridLines && v.length > 1);
                                            H < e.top && (u = "rgba(0,0,0,0)"), H += a.aliasPixel(c), L = e.getPixelForTick(o) + s.labelOffset, g = _, y = P, k = t.left, S = t.right + O, b = x = C = $ = H
                                        }
                                        T.push({
                                            tx1: g,
                                            ty1: b,
                                ...
                                var $, D, L = 0,
                                    E = d(p) / 2;
                                if (m) $ = e.left + (e.right - e.left) / 2, D = "bottom" === i.position ? e.bottom - E - S.bottom : e.top + E + S.top;
                                else {
                                    var F = "left" === i.position;
                                    $ = F ? e.left + E + S.top : e.right - E - S.top, D = e.top + (e.bottom - e.top) / 2, L = F ? -.5 * Math.PI : .5 * Math.PI
                                }
                                o.save(), o.translate($, D), o.rotate(L), o.textAlign = "center", o.textBaseline = "middle", o.fillStyle = k, o.font = C.font, o.fillText(p.labelString, 0, 0), o.restore()
                            }
                            if (h.drawBorder) {
                                ...
                                m ? (V = z = "top" === i.position ? e.bottom : e.top, V += N, z += N) : (R = W = "left" === i.position ? e.right : e.left, R += N, W += N), o.beginPath(), o.moveTo(R, V), o.lineTo(W, z), o.stroke()
                            }
                        }
                    }
                })
    ...
    function(t, e) {
        ...
        function $(t, e, i) {
            if (e) {
                var n, o = i.$context,
                    a = i.$groups;
                e[a._set] && (n = e[a._set][a._key]) && !0 === P.callback(n, [o]) && (t[I]._dirty = !0, i.update(o))
            }
        }
        ...
        var L = {
            ...
            afterDatasetUpdate: function(t, e, i) {
                ...
                for (y.save(), n = 0, a = b.length; n < a; ++n)
                    if ((c = b[n])[I] = [], f && c && !c.hidden && !c._model.skip)
                        for (o = 0, r = v.labels.length; o < r; ++o) l = (s = v.labels[o])._key, (u = new g(s, y, c, n)).$groups = {
                            ...
                            dataset: m,
                            datasetIndex: d
                        }, u.update(u.$context), c[I].push(u), p.push(u);
            ...
            afterUpdate: function(t, e) {
                t[I]._labels = T.prepare(t[I]._datasets, e)
            },
            afterDatasetsDraw: function(t) {
                T.draw(t, t[I]._labels)
            },
            ...
            afterEvent: function(e) {
                var i, o, a, r, s, l, c, u = e[I],
                    d = u._actives,
                    h = u._actives = e.lastActive || [],
                    p = n.arrayDiff(d, h);
                for (i = 0, o = p.length; i < o; ++i)
                    if ((s = p[i])[1])
                        for (a = 0, r = (c = s[0][I] || []).length; a < r; ++a)(l = c[a]).$context.active = 1 === s[1], l.update(l.$context);
...
var _this = this;
! function(t) {
    var e, i, n = ["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function(t) {
            return "input[type=" + t + "]"
        }).join(", ") + ", textarea",
        o = function(t) {
    ...
    c.each(function(t, e) {
        ...
        e.target.type = "text", t("label[for=" + e.target.id + "]").removeClass("active")
    })
}(jQuery);
...
var MaterialSelectViewRenderer = function() {
    ...
    return e.destroy = function() {
        ...
        this.view.$nativeSelect.data("select-id", null).removeClass("initialized"), this.view.$nativeSelect.parent().find("span.caret").remove(), this.view.$nativeSelect.parent().find("input").remove(), this.view.$nativeSelect.unwrap(), $("ul#select-options-" + t).remove()
    }, e.render = function() {
        ...
        this.view.$materialOptionsList.append($('<li class="' + i + " " + n + " " + o + " " + (this.view.options.copyClassesOption ? c : "") + ' ">' + u + '<span class="filtrable">' + d + " " + t.html() + " " + r + " " + s + " " + l + " " + h + "</span></li>"))
    }, _createClass(t, [{
        key: "shouldValidate",
        get: function() {
...
jQuery(function(t) {
        var e, i = function() {
            ...
            }, i._onMutationObserverChange = function(i) {
    ...
    function() {
        ...
        function M(t, e) {
            var i, o, r = n(S),
                ...
                P = _ ? t : t.find("input"),
                I = (P.prop("type"), n("label[for=" + P.attr("id") + "]")),
                A = this;
            if (this.id = (o = ++g + "", (i = "cp") ? i + o : o), this.element = t, this.holder = c, this.options = e, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = _, this.input = P, this.label = I, this.popover = r, this.plate = l, this.hoursView = p, this.minutesView = M, this.amPmBlock = O, this.spanHours = r.find(".clockpicker-span-hours"), this.spanMinutes = r.find(".clockpicker-span-minutes"), this.spanAmPm = r.find(".clockpicker-span-am-pm"), this.footer = r.find(".picker__footer"), this.amOrPm = "", e.twelvehour) {
            ...
            var D, L, E, F, R = n('<div class="clockpicker-tick"></div>');
            if (e.twelvehour)
                for (D = 0; D < 12; D += e.hourstep) L = R.clone(), E = D / 6 * Math.PI, F = y, L.css("font-size", "140%"), L.css({
                    left: b + Math.sin(E) * F - w,
                    top: b - Math.cos(E) * F - w
                }), L.html(0 === D ? 12 : D), p.append(L), L.on(u, z);
            else
                for (D = 0; D < 24; D += e.hourstep) {
                    L = R.clone(), E = D / 6 * Math.PI;
                    var W = D > 0 && D < 13;
                    F = W ? x : y, L.css({
                        left: b + Math.sin(E) * F - w,
                        top: b - Math.cos(E) * F - w
                    }), W && L.css("font-size", "120%"), L.html(0 === D ? "00" : D), p.append(L), L.on(u, z)
                }
            var V = Math.max(e.minutestep, 5);
            for (D = 0; D < 60; D += V)
                for (D = 0; D < 60; D += 5) L = R.clone(), E = D / 30 * Math.PI, L.css({
                    left: b + Math.sin(E) * y - w,
                    top: b - Math.cos(E) * y - w
                }), L.css("font-size", "140%"), L.html(v(D)), M.append(L), L.on(u, z);
            ...
            function z(t, i) {
                ...
                if (!i || !(f < y - w || f > y + w)) {
                    ...
                    s && l.append(A.canvas), A.setHand(u, p, !i, !0), a.off(d).on(d, function(t) {
                        ...
                        (i || m) && o === u && s === p && A.setHand(o, s), "hours" === A.currentView ? A.toggleView("minutes", C / 2) : e.autoclose && (A.minutesView.addClass("clockpicker-dial-out"), setTimeout(function() {
                            A.done()
                        }, C / 2)), l.prepend(N), clearTimeout(v), A.popover.removeClass("clockpicker-moving"), a.off(d)
                    })
                }
            }
            if (l.on(u, function(t) {
                ...
                var H = f("g");
                H.setAttribute("transform", "translate(" + b + "," + b + ")");
                var j = f("circle");
                ...
                var X = f("circle");
                X.setAttribute("class", "clockpicker-canvas-fg"), X.setAttribute("r", 5), H.appendChild(Y), H.appendChild(q), H.appendChild(X), H.appendChild(j), B.appendChild(H), N.append(B), this.hand = Y, this.bg = q, this.fg = X, this.bearing = j, this.g = H, this.canvas = N
            }
            T(this.options.init)
        }
        ...
        M.DEFAULTS = {
            ...
            if (!this.isShown) {
                ...
                this.input.blur(), this.popover.addClass("picker--opened"), this.input.addClass("picker__input picker__input--active"), n(document.body).css("overflow", "hidden"), this.isAppended || (this.popover.insertAfter(this.input), this.options.twelvehour && (this.amOrPm = "PM", this.options.ampmclickable ? (this.spanAmPm.children("#click-pm").addClass("text-primary"), this.spanAmPm.children("#click-am").removeClass("text-primary")) : (this.amPmBlock.children(".am-button").removeClass("active"), this.amPmBlock.children(".pm-button").addClass("active"), this.spanAmPm.empty().append("PM"))), o.on("resize.clockpicker" + this.id, function() {
                    e.isShown && e.locate()
                }), this.isAppended = !0), this.parseInputValue(), this.spanHours.html(v(this.hours)), this.spanMinutes.html(v(this.minutes)), this.options.twelvehour && this.spanAmPm.empty().append(this.amOrPm), this.toggleView("hours"), this.locate(), this.isShown = !0, a.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, m(function(t) {
                    var i = n(t.target);
    ...
    function(t, e) {
        ...
        return function(t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, v, g, b, y, x, w, k, C, S, M, T, O, _, P, I, A, $, D, L, E, F, R, W, V, z, N, B, H, j, Y, q, X, U, K, Q, Z, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Et = null,
                Ft = function() {
                    Et && (o.unbind(document, "mousemove", Ft), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")), Et = setTimeout(function() {
                        Et = null
                    }, 100)
                },
                Rt = function(t, e) {
                ...
                Bt = function(t) {
                    t && (X || q || et || B) && (t.preventDefault(), t.stopPropagation())
                },
                Ht = function() {
                ...
                Qt = {
                    ...
                    init: function() {
                        if (!s && !l) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), D = t.className, s = !0, R = o.detectFeatures(), A = R.raf, $ = R.caf, _ = R.transform, E = R.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                                ...
                                function() {
                                    if (_) {
                                        var e = R.perspective && !I;
                                        return b = "translate" + (e ? "3d(" : "("), void(y = R.perspective ? ", 0px)" : ")")
                                    }
                                    _ = "left", o.addClass(t, "pswp--ie"), It = function(t, e) {
                                        e.left = t + "px"
                                    }, Pt = function(t) {
                            ...
                            e && (a.ui = new e(a, o)).init(), St("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= ze()) && (u = 0), a.currItem = Ve(u), (R.isOldIOSPhone || R.isOldAndroid) && (vt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (vt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === F && (St("initialLayout"), F = L = o.getScrollY());
                            var c = "pswp--open ";
                            for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += I ? "pswp--touch" : "pswp--notouch", c += R.animationName ? " pswp--css_animation" : "", c += R.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, mt = null, i = 0; 3 > i; i++) It((i + h) * ft.x, k[i].el.style);
                            E || o.bind(a.scrollWrap, f, a), Ct("initialZoomInEnd", function() {
                    ...
                    close: function() {
                        s && (s = !1, l = !0, St("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ft), R.transform && o.unbind(a.scrollWrap, "click", a), j && o.unbind(window, p, a), St("unbindEvents"), Ne(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function() {
                        St("destroy"), Ee && clearTimeout(Ee), t.setAttribute("aria-hidden", "true"), t.className = D, x && clearInterval(x), o.unbind(a.scrollWrap, f, a), o.unbind(window, "scroll", a), pe(), Ut(), kt = null
                    },
                    ...
                    goTo: function(t) {
                        var e = (t = wt(t)) - u;
                        mt = e, u = t, a.currItem = Ve(u), ht -= e, At(ft.x * ht), Ut(), et = !1, a.updateCurrItem()
                    },
                    next: function() {
                        a.goTo(u + 1)
                    },
                    ...
                    updateCurrItem: function(t) {
                        if (0 !== mt) {
                            ...
                            if (!(t && 2 > i)) {
                                ...
                                for (var n = 0; i > n; n++) mt > 0 ? (e = k.shift(), k[2] = e, It((++h + 2) * ft.x, e.el.style), a.setContent(e, u - i + n + 1 + 1)) : (e = k.pop(), k.unshift(e), It(--h * ft.x, e.el.style), a.setContent(e, u + i - n - 1 - 1));
                                if (tt && 1 === Math.abs(mt)) {
                                    var o = Ve(C);
                    ...
                    updateSize: function(e) {
                        ...
                        if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, Ht(), ft.x = dt.x + Math.round(dt.x * r.spacing), ft.y = dt.y, At(ft.x * ht), St("beforeResize"), void 0 !== h) {
                            for (var n, s, l, c = 0; 3 > c; c++) n = k[c], It((c + h) * ft.x, n.el.style), l = u + c - 1, r.loop && ze() > 2 && (l = wt(l)), (s = Ve(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (Ye(s, dt), Ke(s), Pt(s));
                            w = !1
                        }
                ...
                Me = function(t, e) {
                    var i, n, o, s, l = ut[t] + e[t],
                        ...
                        u = ce.x + e.x,
                        d = ce.x - ne.x;
                    return i = l > J.min[t] || l < J.max[t] ? r.panEndFriction : 1, l = ut[t] + e[t] * i, !r.allowPanToNext && v !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || q || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && ze() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && ze() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || K || v > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (At(s, !0), K = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : K || (ut.x += e.x * i)), void 0 !== s)
                },
                Te = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!H || "mousedown" !== t.type) {
                            ...
                            var i = Se(t),
                                n = i.length;
                            Q = null, Ut(), j && 1 !== n || (j = nt = !0, o.bind(window, p, a), N = rt = ot = B = K = X = Y = q = !1, it = null, St("firstTouchStart", i), Dt(ct, ut), lt.x = lt.y = 0, Dt(te, i[0]), Dt(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                    ...
                    if (Q) {
                        ...
                        if (0 !== t)
                            if (Dt(Zt, Q[0]), Jt.x = Zt.x - te.x, Jt.y = Zt.y - te.y, Z && t > 1) {
                                ...
                                0 > n && (n = 0), ye(Zt, Gt, se), lt.x += se.x - de.x, lt.y += se.y - de.y, Dt(de, se), ut.x = $t("x", i), ut.y = $t("y", i), N = i > v, v = i, _t()
                            } else {
                                if (!it) return;
                                ...
                                if ("v" === it && r.closeOnVerticalDrag && "fit" === r.scaleMode && v === a.currItem.initialZoomLevel) {
                                    lt.y += Jt.y, ut.y += Jt.y;
                                    var c = xe();
                                    return B = !0, St("onVerticalDrag", c), Tt(c), void _t()
                                }(function(t, e, i) {
                                    if (t - V > 50) {
                                        var n = oe.length > 2 ? oe.shift() : {};
                                        n.x = e, n.y = i, oe.push(n), V = t
                                    }
                                })(Mt(), Zt.x, Zt.y), X = !0, J = a.currItem.bounds, Me("x", Jt) || (Me("y", Jt), Lt(ut), _t())
                            }
                    }
                },
                Pe = function(t) {
                    ...
                    var c = -1;
                    if (0 === l && (j = !1, o.unbind(window, p, a), pe(), Z ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", Z && 2 > l && (Z = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Q = null, X || q || et || B)
                        if (Ut(), z || (z = Ie()), z.calculateSwipeSpeed("x"), B)
                        ...
                        if (!et) return "swipe" !== n ? void Le() : void(!K && v > a.currItem.fitRatio && Ae(z))
                    }
                },
                Ie = function() {
                    var t, e, i = {
                ...
                $e = function(t, e) {
                    ...
                    var d, h = ft.x * ht,
                        p = Math.abs(h - ce.x);
                    return i || h > ce.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, re === u && (i = !1), et = !0, St("mainScrollAnimStart"), Kt("mainScroll", ce.x, h, d, o.easing.cubic.out, At, function() {
                ...
                Le = function() {
                    ...
                    e > v ? t = e : v > i && (t = i);
                    var n, r = at;
                    return ot && !N && !rt && e > v ? (a.close(), !0) : (ot && (n = function(t) {
                        Tt((1 - r) * t + r)
            ...
            xt("Gestures", {
                publicMethods: {
                    initGestures: function() {
                        ...
                        (P = R.pointerEvent) && R.touch && (R.touch = !1), P ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : R.touch ? (t("touch", "start", "move", "end", "cancel"), I = !0) : t("mouse", "down", "move", "up"), p = M + " " + T + " " + O, f = S, P && !I && (I = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = I, m[S] = Te, m[M] = Oe, m[T] = Pe, O && (m[O] = m[T]), R.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[M], m.mouseup = m[T]), I || (r.allowPanToNext = !1)
                    }
                }
            });
            var Ee, Fe, Re, We, Ve, ze, Ne = function(e, i, n, s) {
                    var l;
                    Ee && clearTimeout(Ee), We = !0, Re = !0, e.initialLayout ? (l = e.initialLayout, e.initialLayout = null) : l = r.getThumbBoundsFn && r.getThumbBoundsFn(u);
                    ...
                    ! function() {
                        ...
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (v = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, _t()), Xt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
                            ...
                            if (St("initialZoom" + (n ? "Out" : "In")), n) {
                                ...
                                i ? Kt("initialZoom", 0, 1, d, o.easing.cubic.out, p, h) : (p(1), Ee = setTimeout(h, d + 20))
                            } else v = e.initialZoomLevel, Dt(ut, e.initialPosition), _t(), Tt(1), s ? t.style.opacity = 1 : Tt(1), Ee = setTimeout(h, d + 20)
                        }, n ? 25 : 90)
                    }()
                },
                Be = {},
                ...
                Qe = function() {
                    if (He.length) {
                        for (var t, e = 0; e < He.length; e++)(t = He[e]).holder.index === t.index && qe(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
                        He = []
                    }
                };
            xt("Controller", {
                publicMethods: {
                    ...
                    initController: function() {
                        o.extend(r, je, !0), a.items = Fe = i, Ve = a.getItemAt, ze = r.getNumItemsFn, r.loop, ze() < 3 && (r.loop = !1), Ct("beforeChange", function(t) {
                            var e, i = r.preload,
                                n = null === t || t >= 0,
                                o = Math.min(i[0], ze()),
                                s = Math.min(i[1], ze());
                    ...
                    allowProgressiveImg: function() {
                        return r.forceProgressiveLoading || !I || r.mouseUsed || screen.width > 1200
                    },
                    setContent: function(t, e) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Ke(l, n), qe(0, l, c, n));
                                ...
                                if (l.loadComplete = function(i) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                ...
                                                i.imageAppended ? !We && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : R.transform && (et || We) ? He.push({
                                                    item: i,
                                                    baseDiv: c,
                                                    img: i.img,
                                                    index: e,
                                ...
                                l.loading || Xe(l), a.allowProgressiveImg() && (!Re && R.transform ? He.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: e,
                            ...
                            Re || e !== u ? Pt(l) : (tt = c.style, Ne(l, n || l.img)), t.el.innerHTML = "", t.el.appendChild(c)
                        } else t.el.innerHTML = ""
                    },
    ...
    function(t, e) {
        ...
        return function(t, e) {
            var i, n, o, a, r, s, l, c, u, d, h, p, f, m, v, g, b, y, x = this,
                ...
                M = function(t) {
                    if (g) return !0;
                    t = t || window.event, v.timeToIdle && v.mouseUsed && !u && E();
                ...
                A = function(e) {
                    ...
                    return t.shout("shareLinkClick", e, i), !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), C || I(), 1))
                },
                $ = function() {
            ...
            x.init = function() {
                e.extend(t.options, S, !0), v = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen,
                    function() {
                        ...
                        C || I(), b && clearInterval(b), e.unbind(document, "mouseout", F), e.unbind(document, "mousemove", E), e.unbind(n, "pswpTap click", M), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (v.hideAnimationDuration = 0, i.exit()), i = null)
                    }), d("destroy", function() {
                    ...
                    function() {
                        ...
                        e.bind(document, "mousemove", E), e.bind(document, "mouseout", F), b = setInterval(function() {
                            2 == ++L && x.setIdle(!0)
                        }, v.timeToIdle / 2)
                ...
                k && t.currItem ? (x.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(t.currItem, o), O(o, "caption--empty", !t.currItem.title)), w = !0) : w = !1, C || I(), _()
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
    function(t, e) {
        "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : window.PerfectScrollbar = e()
    }(0, function() {
        "use strict";
        ...
        function x(t, e) {
            ...
            function y(e) {
                f[d] = m + g * (e[o] - v), c(t, h), b(t), e.stopPropagation(), e.preventDefault()
            }
            ...
            t.event.bind(t[r], "mousedown", function(e) {
                m = f[d], v = e[o], g = (t[n] - t[i]) / (t[a] - t[l]), t.event.bind(t.ownerDocument, "mousemove", y), t.event.once(t.ownerDocument, "mouseup", x), t[p].classList.add(s.state.clicking), e.stopPropagation(), e.preventDefault()
            })
        }
        var w = {
                        ...
                        if (! function(e, n, o) {
                                ...
                                for (var a = e; a && a !== i;) {
                                    ...
                                    if ([r.overflow, r.overflowX, r.overflowY].join("").match(/(scroll|auto)/)) {
                                        ...
                                        if (l > 0 && !(0 === a.scrollTop && o > 0 || a.scrollTop === l && o < 0)) return !0;
                                        var c = a.scrollWidth - a.clientWidth;
                                        if (c > 0 && !(0 === a.scrollLeft && n < 0 || a.scrollLeft === c && n > 0)) return !0
                                    }
                                    a = a.parentNode
                                }
                                return !1
                            ...
                            if (function(e, n, o) {
                                    ...
                                    for (var a = e; a && a !== i;) {
                                        ...
                                        if ([r.overflow, r.overflowX, r.overflowY].join("").match(/(scroll|auto)/)) {
                                            var l = a.scrollHeight - a.clientHeight;
                                            if (l > 0 && !(0 === a.scrollTop && o > 0 || a.scrollTop === l && o < 0)) return !0;
                                            var c = a.scrollLeft - a.clientWidth;
                                            if (c > 0 && !(0 === a.scrollLeft && n < 0 || a.scrollLeft === c && n > 0)) return !0
                                        }
                                        a = a.parentNode
                                    }
                    ...
                    if (e.$autocompleteWrap.empty(), n.length) {
                        for (var o in e.options.data)
                            if (-1 !== e.options.data[o].toLowerCase().indexOf(n.toLowerCase())) {
                                var a = t("<li>" + e.options.data[o] + "</li>");
